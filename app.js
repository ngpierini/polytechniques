...
function stepGrowthTemplate() {
  return `
    ...
    <div class="card">
      ...
      <p class="guide-note">
        Neither knows anything about side reactions. A polyester that transesterifies, or a urethane forming allophanate above 120&nbsp;&deg;C, is building network by a route the functionality count never saw. For mixed functionalities, off-stoichiometry and the sol fraction past gelation, <a href="network-formation.html">Network Formation</a> runs the full recursive calculation. Past the gel point, <a href="crosslink-density.html">Crosslink Density</a> measures what the network became.
      </p>
      <p class="guide-note">
